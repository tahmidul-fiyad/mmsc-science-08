    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          {/* Badge */}
          <div className="inline-flex items-center space-x-2 bg-glass backdrop-blur-sm border border-glass-border rounded-full px-6 py-2 mb-8">
            <img src="/lovable-uploads/40b92813-5470-4ed5-aef2-a658366074ce.png" alt="MMSC Logo" className="w-5 h-5 rounded-full" />
            <span className="text-sm font-medium">Motijheel Model School & College</span>
          </div>
