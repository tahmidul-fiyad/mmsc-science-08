  ...
  const contactInfo = [
    {
      ...
      details: [
        ...
        'Atish Dipankar Road, Central Basabo,',
        'Sabujbagh Thana, Dhaka-1214'
      ],
    ...
    },
    {
      ...
      title: 'Phone',
      details: [
        'Chief Advisor: +880 1819-184952',
        'President: +880 1790-241878',
        'Ex-President: +880 1716-268517'
      ],
    ...
    },
    {
      icon: Mail,
      title: 'Email',
      details: ['mmscscience.techforum@gmail.com'],
            ...
            <Card className="bg-gradient-card border-glass-border backdrop-blur-sm p-8 h-full">
              ...
              <div className="space-y-4">
                ...
                <Button 
                  variant="outline"
                  className="w-full border-glass-border bg-glass hover:bg-gradient-card transition-all duration-300"
                  onClick={() => window.open('mailto:mmscscience.techforum@gmail.com')}
                >
