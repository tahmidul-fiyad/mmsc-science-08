...
import { Mail, Phone, MapPin, Facebook, Youtube, Github } from 'lucide-react';
...
export const Footer = () => {
  ...
  const socialLinks = [
    { icon: Facebook, href: 'https://www.facebook.com/share/19ekP3LEnX/', label: 'Facebook' },
  ];
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-2 mt-2">
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-auto p-1 text-muted-foreground hover:text-red-500 transition-colors"
                  onClick={() => window.open('https://youtube.com/@infinitestrikes', '_blank')}
                >
                ...
                <Button
                  ...
                  onClick={() => window.open('https://github.com/tahmidul-fiyad', '_blank')}
                >
