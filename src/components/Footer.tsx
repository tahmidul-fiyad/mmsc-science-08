...
import { Atom, Mail, Phone, MapPin, Facebook, Twitter, Instagram, Youtube } from 'lucide-react';
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-primary rounded-full blur-sm opacity-60"></div>
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-muted-foreground">
                  <div>Motijheel Model School</div>
                  <div>& College, Dhaka-1000</div>
                </div>
              </div>
              
              <div className="flex items-center space-x-2">
                <Phone className="w-4 h-4 text-secondary flex-shrink-0" />
                <span className="text-sm text-muted-foreground">+880-2-9563427</span>
              </div>
              
              <div className="flex items-center space-x-2">
                <Mail className="w-4 h-4 text-accent flex-shrink-0" />
                <span className="text-sm text-muted-foreground">scienceclub@mmsc.edu.bd</span>
              </div>
            </div>
          ...
          <div className="flex items-center space-x-4 text-xs text-muted-foreground">
            <div className="text-center">
              <p className="mb-1">
                ...
                <span className="text-xs">Student of Class IX in MMSC</span>
              </p>
