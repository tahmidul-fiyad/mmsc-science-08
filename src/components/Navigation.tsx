      ...
      <div className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div 
            ...
            onClick={() => window.open('https://mmodel.edu.bd', '_blank')}
          >
            <div className="relative">
              ...
              <div className="relative bg-gradient-primary p-3 rounded-full">
                <Atom className="w-6 h-6 text-white animate-pulse-glow" />
              </div>
            </div>
            <div>
              <h1 className="text-xl font-bold bg-gradient-primary bg-clip-text text-transparent">
                <span className="sm:hidden">MMSC Science Club</span>
                <span className="hidden sm:block">MMSC Science and Technology Forum</span>
              </h1>
